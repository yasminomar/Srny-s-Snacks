        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Towen = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesInProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoriesInProduct_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CategoriesInProduct_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesInProduct_CategoryId",
                table: "CategoriesInProduct",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriesInProduct_ProductId",
                table: "CategoriesInProduct",
                column: "ProductId");
